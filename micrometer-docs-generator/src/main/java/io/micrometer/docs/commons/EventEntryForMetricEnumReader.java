 ...
 */
public class EventEntryForMetricEnumReader implements EntryEnumReader<EventEntry> {

    public static final EventEntryForMetricEnumReader INSTANCE = new EventEntryForMetricEnumReader();
